...
if __name__ == "__main__":    
    ...
    pl1 = Playlist("Coldplay - Mylo Xyloto")
    for mu in album1.getFaixas():
        pl1.addMusica(mu)

    # Criar uma playlist com todas as músicas do Coldplay  
    pl2 = Playlist("Coldplay todas")
    for mu in art1.getMusicas():
        pl2.addMusica(mu)

    # Criar uma playlist contendo uma música de cada album
    pl3 = Playlist("1:1")
    pl3.addMusica(album1.getFaixas()[0])
    pl3.addMusica(album2.getFaixas()[0])