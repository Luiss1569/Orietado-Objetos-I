...
class LimitePrincipal():
    def __init__(self, root, controle):
        ...
        self.estudanteMenu.add_command(label="Buscar", \
                    command=self.controle.buscarEstudantes)
        ...
        self.discipMenu.add_command(label="Buscar", \
                    command=self.controle.buscarDisciplinas)     
        ...
        self.turmaMenu.add_command(label="Buscar", \
                    command=self.controle.buscarTurmas)              
        self.menubar.add_cascade(label="Turma", \
                    menu=self.turmaMenu)        

        self.root.config(menu=self.menubar)
        
    def mostrarJanelaBusca(self, title, desc):
         return simpledialog.askstring(title, desc, parent=self.root)
...
class ControlePrincipal():       
    def __init__(self):
        ...
        self.ctrlEstudante = est.CtrlEstudante(self)
    ...
    def buscarEstudantes(self):
        self.ctrlEstudante.buscarEstudantes()
    
    def buscarDisciplinas(self):
        self.ctrlDisciplina.buscarDisciplinas()
        
    def buscarTurmas(self):
        self.ctrlTurma.buscarTurmas()
